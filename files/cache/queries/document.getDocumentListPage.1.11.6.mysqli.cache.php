...
${'s_email_addres19_argument'} = new ConditionArgument('s_email_addres', $args->s_email_addres, 'like');
${'s_email_addres19_argument'}->createConditionValue();
if(!${'s_email_addres19_argument'}->isValid()) return ${'s_email_addres19_argument'}->getErrorMessage();
} else
${'s_email_addres19_argument'} = NULL;if(${'s_email_addres19_argument'} !== null) ${'s_email_addres19_argument'}->setColumnType('varchar');
...
${'list_order34_argument'} = new ConditionArgument('list_order', $args->list_order, 'less');
${'list_order34_argument'}->checkFilter('number');
${'list_order34_argument'}->createConditionValue();
if(!${'list_order34_argument'}->isValid()) return ${'list_order34_argument'}->getErrorMessage();
} else
${'list_order34_argument'} = NULL;if(${'list_order34_argument'} !== null) ${'list_order34_argument'}->setColumnType('number');
if(isset($args->rev_list_order)) {
${'rev_list_order35_argument'} = new ConditionArgument('rev_list_order', $args->rev_list_order, 'more');
${'rev_list_order35_argument'}->checkFilter('number');
${'rev_list_order35_argument'}->createConditionValue();
if(!${'rev_list_order35_argument'}->isValid()) return ${'rev_list_order35_argument'}->getErrorMessage();
} else
${'rev_list_order35_argument'} = NULL;if(${'rev_list_order35_argument'} !== null) ${'rev_list_order35_argument'}->setColumnType('number');
if(isset($args->update_order)) {
${'update_order36_argument'} = new ConditionArgument('update_order', $args->update_order, 'less');
${'update_order36_argument'}->checkFilter('number');
${'update_order36_argument'}->createConditionValue();
if(!${'update_order36_argument'}->isValid()) return ${'update_order36_argument'}->getErrorMessage();
} else
${'update_order36_argument'} = NULL;if(${'update_order36_argument'} !== null) ${'update_order36_argument'}->setColumnType('number');
if(isset($args->rev_update_order)) {
${'rev_update_order37_argument'} = new ConditionArgument('rev_update_order', $args->rev_update_order, 'more');
${'rev_update_order37_argument'}->checkFilter('number');
${'rev_update_order37_argument'}->createConditionValue();
if(!${'rev_update_order37_argument'}->isValid()) return ${'rev_update_order37_argument'}->getErrorMessage();
} else
${'rev_update_order37_argument'} = NULL;if(${'rev_update_order37_argument'} !== null) ${'rev_update_order37_argument'}->setColumnType('number');
if(isset($args->rev_regdate)) {
${'rev_regdate38_argument'} = new ConditionArgument('rev_regdate', $args->rev_regdate, 'less');
${'rev_regdate38_argument'}->checkFilter('number');
${'rev_regdate38_argument'}->createConditionValue();
if(!${'rev_regdate38_argument'}->isValid()) return ${'rev_regdate38_argument'}->getErrorMessage();
} else
${'rev_regdate38_argument'} = NULL;if(${'rev_regdate38_argument'} !== null) ${'rev_regdate38_argument'}->setColumnType('date');
if(isset($args->regdate)) {
${'regdate39_argument'} = new ConditionArgument('regdate', $args->regdate, 'more');
${'regdate39_argument'}->checkFilter('number');
...
,new ConditionWithArgument('`email_address`',$s_email_addres19_argument,"like", 'or')
...
,new ConditionGroup(array(
new ConditionWithArgument('`list_order`',$list_order34_argument,"less", 'and')
,new ConditionWithArgument('`list_order`',$rev_list_order35_argument,"more", 'and')
,new ConditionWithArgument('`update_order`',$update_order36_argument,"less", 'and')
,new ConditionWithArgument('`update_order`',$rev_update_order37_argument,"more", 'and')
,new ConditionWithArgument('`regdate`',$rev_regdate38_argument,"less", 'and')
,new ConditionWithArgument('`regdate`',$regdate39_argument,"more", 'and')),'and')
));
