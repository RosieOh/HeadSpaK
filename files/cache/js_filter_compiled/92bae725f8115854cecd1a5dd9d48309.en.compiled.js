...
(function($){
	...
	v.cast("ADD_FILTER", ["insert", {'nick_name': {required:true,maxlength:20},'password': {required:true},'email_address': {required:true,maxlength:250},'homepage': {maxlength:250},'title': {required:true,minlength:1,maxlength:250},'content': {},'category_srl': {required:true}}]);
