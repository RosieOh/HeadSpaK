function move_category(form){ return legacy_filter('move_category', form, 'document', 'procDocumentMoveCategory', completeMoveCategory, ['error','message','xml_file','source_category_srl'], '确定要移动吗?', {}) };
(function($){
