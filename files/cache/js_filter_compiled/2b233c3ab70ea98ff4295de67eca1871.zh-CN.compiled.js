function insert_editor_module_config(form){ return legacy_filter('insert_editor_module_config', form, 'editor', 'procEditorInsertModuleConfig', filterAlertMessage, ['error','message'], '确定要提交吗?', {}) };
(function($){
