...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_header.html') ?>
<!--#Meta:modules/board/skins/notice/js/editor.js--><?php $__tmp=array('modules/board/skins/notice/js/editor.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if(Mobile::isMobileCheckByAgent() && $__Context->mi->m_editor!=3){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_write_form_mobile.html');
} ?>
