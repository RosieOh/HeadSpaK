...
$__Context->oDocument->getEditor()->option;
 ?>
<!--#Meta:modules/board/skins/market_search/css/m_editor.css--><?php $__tmp=array('modules/board/skins/market_search/css/m_editor.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/market_search/js/editor_m.js--><?php $__tmp=array('modules/board/skins/market_search/js/editor_m.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/market_search/js/ajaxfileupload.js--><?php $__tmp=array('modules/board/skins/market_search/js/ajaxfileupload.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<script>//<![CDATA[
...
echo $__Context->oDocument->getContentText();
	...
	<?php if(count($__Context->extra_keys)){ ?><table class="et_vars exForm bd_tb">
		...
		<?php if($__Context->extra_keys&&count($__Context->extra_keys))foreach($__Context->extra_keys as $__Context->key=>$__Context->val){ ?><tr class="<?php echo $__Context->val->eid ?>">
...
<!--#Meta:modules/board/skins/market_search/js/editor_wysiwyg.js--><?php $__tmp=array('modules/board/skins/market_search/js/editor_wysiwyg.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/market_search/js/bootstrap-wysiwyg.js--><?php $__tmp=array('modules/board/skins/market_search/js/bootstrap-wysiwyg.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/market_search/js/jquery.hotkeys.js--><?php $__tmp=array('modules/board/skins/market_search/js/jquery.hotkeys.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
		<div id="alerts"></div>
...
<!--#Meta:modules/board/skins/market_search/js/editor_textarea.js--><?php $__tmp=array('modules/board/skins/market_search/js/editor_textarea.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
