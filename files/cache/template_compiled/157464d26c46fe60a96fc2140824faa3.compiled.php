<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/page/skins/07-01-partner/content.css--><?php $__tmp=array('modules/page/skins/07-01-partner/content.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<div class="sub_wrap">
	...
	<div class="sub_tabcon_wrap">
		<div class="sub_tabcon">
			<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/page/skins/07-01-partner','tab_01.html') ?>
		</div>
	</div>
</div>
...
<div class="sub_wrap">
	...
	<div class="sub_tab_wrap">
		<div class="sub_tab on"><a>head spa k 专门店介绍</p></div>
		<div class="sub_tab"><a href="/index.php?mid=headspa_markets">国内</a></div>
		<div class="sub_tab"><a href="/index.php?mid=market_foreign">海外</a></div>
	</div>
	<select class="sub_sel" onchange="location.href=this.value">
		<option selected="selected" value="">head spa k 专门店介绍</option>
		<option value="/index.php?mid=headspa_markets">国内</option>
