...
$__Context->oDocument->getEditor()->option;
 ?>
<!--#Meta:modules/board/skins/notice/css/m_editor.css--><?php $__tmp=array('modules/board/skins/notice/css/m_editor.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/notice/js/editor_m.js--><?php $__tmp=array('modules/board/skins/notice/js/editor_m.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/notice/js/ajaxfileupload.js--><?php $__tmp=array('modules/board/skins/notice/js/ajaxfileupload.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<script>//<![CDATA[
...
<!--#Meta:modules/board/skins/notice/js/editor_wysiwyg.js--><?php $__tmp=array('modules/board/skins/notice/js/editor_wysiwyg.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/notice/js/bootstrap-wysiwyg.js--><?php $__tmp=array('modules/board/skins/notice/js/bootstrap-wysiwyg.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/notice/js/jquery.hotkeys.js--><?php $__tmp=array('modules/board/skins/notice/js/jquery.hotkeys.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
		<div id="alerts"></div>
...
<!--#Meta:modules/board/skins/notice/js/editor_textarea.js--><?php $__tmp=array('modules/board/skins/notice/js/editor_textarea.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
