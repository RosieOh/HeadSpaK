...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_header.html') ?>
<!--#Meta:modules/board/skins/market_search_foreign/js/editor.js--><?php $__tmp=array('modules/board/skins/market_search_foreign/js/editor.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if(Mobile::isMobileCheckByAgent() && $__Context->mi->m_editor!=3){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_write_form_mobile.html');
} ?>
