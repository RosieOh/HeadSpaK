...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_header.html') ?>
<!--#Meta:modules/board/skins/market_search/js/editor.js--><?php $__tmp=array('modules/board/skins/market_search/js/editor.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if(Mobile::isMobileCheckByAgent() && $__Context->mi->m_editor!=3){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_write_form_mobile.html');
} ?>
