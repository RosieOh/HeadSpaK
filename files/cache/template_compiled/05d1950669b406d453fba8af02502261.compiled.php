...
<form action="./" method="post" onsubmit="return procFilter(this, insert_comment)" class="bd_wrt cmt_wrt clear"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment(), ENT_COMPAT | ENT_HTML401, 'UTF-8', false) ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
	...
	<div class="edit_opt clear"<?php if($__Context->mi->cmt_wrt!='editor'){ ?> style="display:none"<?php } ?>>
		...
		<span class="itx_wrp">
			<input type="text" name="nick_name" id="nick_name_<?php echo $__Context->oDocument->document_srl ?>" class="itx n_p" placeholder="<?php echo $__Context->lang->writer ?>" />
		</span>
		<span class="itx_wrp">
			<input type="password" name="password" id="password_<?php echo $__Context->oDocument->document_srl ?>" class="itx n_p" placeholder="<?php echo $__Context->lang->password ?>" />
		</span>
		<span class="itx_wrp">
			<input type="text" name="email_address" id="email_address_<?php echo $__Context->oDocument->document_srl ?>" class="itx m_h" placeholder="<?php echo $__Context->lang->email_address ?>" />
		</span>
		<span class="itx_wrp">
			<input type="text" name="homepage" id="homepage_<?php echo $__Context->oDocument->document_srl ?>" class="itx m_h" placeholder="<?php echo $__Context->lang->homepage ?>" />
		</span>
		<?php } ?>
