...
<div class="sub_wrap">
	...
	<div class="sub_tab_wrap">
		<div class="sub_tab on"><a>헤드스파 K 파트너 안내</p></div>
	...
	<select class="sub_sel" onchange="location.href=this.value">
		<option selected="selected" value="">헤드스파 K 파트너 안내</option>
...
<div class="sub_wrap">
	...
	<div class="sub_tab_wrap">
		<div class="sub_tab on"><a>Partnership guide</p></div>
	...
	<select class="sub_sel" onchange="location.href=this.value">
		<option selected="selected" value="">Partnership guide</option>
