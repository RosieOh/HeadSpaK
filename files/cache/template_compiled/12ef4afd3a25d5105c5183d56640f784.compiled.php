...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','__setting.html') ?>
<!--#Meta:modules/board/skins/market_search_foreign/js/imagesloaded.pkgd.min.js--><?php $__tmp=array('modules/board/skins/market_search_foreign/js/imagesloaded.pkgd.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/market_search_foreign/js/jquery.cookie.js--><?php $__tmp=array('modules/board/skins/market_search_foreign/js/jquery.cookie.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--#Meta:modules/board/skins/market_search_foreign/js/jquery.autogrowtextarea.min.js--><?php $__tmp=array('modules/board/skins/market_search_foreign/js/jquery.autogrowtextarea.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/market_search_foreign/js/board.js--><?php $__tmp=array('modules/board/skins/market_search_foreign/js/board.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<script>//<![CDATA[
...
//]]></script>
<?php if($__Context->mid == 'market_foreign'){ ?>
	...
	<div class="sub_tab_wrap">
		...
		<div class="sub_tab on"><a>해외</a></div>
	</div>
	<select class="sub_sel" onchange="location.href=this.value">
		<option value="/index.php?mid=partners">헤드스파 K 파트너 안내</option>
		<option value="/index.php?mid=headspa_markets">국내</option>
		<option selected="selected" value="">해외</option>
	</select>
	<?php } ?>
	...
	<div class="sub_tab_wrap">
		...
		<div class="sub_tab on"><a>Overseas markets</a></div>
	</div>
	<select class="sub_sel" onchange="location.href=this.value">
		...
		<option selected="selected" value="">Overseas markets</option>
	</select>
	<?php } ?>
<?php } ?>
<?php if($__Context->mi->default_style=='viewer' && $__Context->grant->view){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_viewer.html');
} ?>
<?php if($__Context->mi->default_style!='viewer'){ ?>
<!--#Meta:modules/board/skins/market_search_foreign/js/jquery.masonry.min.js--><?php $__tmp=array('modules/board/skins/market_search_foreign/js/jquery.masonry.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--#Meta:modules/board/skins/market_search_foreign/css/wizard.css--><?php $__tmp=array('modules/board/skins/market_search_foreign/css/wizard.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_wizard.php') ?>
<?php } ?>
...
<!--#Meta:modules/board/skins/market_search_foreign/js/font_ng.js--><?php $__tmp=array('modules/board/skins/market_search_foreign/js/font_ng.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_read_nav.html');
} ?>
</div>
<?php if($__Context->oDocument->isExists()){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_read.html');
} ?>
...
<div class="tl_srch clear">
	...
	<?php if($__Context->mi->srch_window!='N'){ ?><div class="bd_faq_srch<?php if($__Context->mi->srch_window==3){ ?> clear<?php } ?>"<?php if($__Context->mi->srch_window==2 || $__Context->search_keyword){ ?> style="display:block"<?php } ?>>
		<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_search.html') ?>
	</div><?php } ?>
</div>
...
<?php if($__Context->mi->default_style=='list'){ ?>
	...
	<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_list_normal.html') ?>
	<?php }else{ ?>
	<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_list_m.html') ?>
	<?php } ?>
<?php }elseif($__Context->mi->default_style=='webzine'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_list_webzine.html') ?>
<?php }elseif($__Context->mi->default_style=='gallery'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_list_gallery.html') ?>
<?php }elseif($__Context->mi->default_style=='cloud_gall'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_list_cloud_gall.html') ?>
<?php }elseif($__Context->mi->default_style=='faq'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_list_faq.html') ?>
<?php }elseif($__Context->mi->default_style=='guest' && !$__Context->oDocument->isExists()){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_list_guest.html') ?>
...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_read.html') ?>
...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search_foreign','_footer.html') ?>
<?php } ?>
