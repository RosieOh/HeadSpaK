...
echo htmlspecialchars($__Context->selected_var->name, ENT_COMPAT | ENT_HTML401, 'UTF-8', false);
			...
			<div class="x_control-group">
				...
				<div class="x_controls">
					<input type="text" name="default" id="default" value="<?php if(strpos($__Context->selected_var->default, '$user_lang->') === false){;
echo escape($__Context->selected_var->default, false);
}else{;
echo htmlspecialchars($__Context->selected_var->default, ENT_COMPAT | ENT_HTML401, 'UTF-8', false);
} ?>" class="lang_code" placeholder="Ex) Red, Green, Blue" />
			...
			<div class="x_control-group">
				...
				<div class="x_controls">
					<input type="text" name="desc" id="desc" value="<?php if(strpos($__Context->selected_var->desc, '$user_lang->') === false){;
echo escape($__Context->selected_var->desc, false);
}else{;
echo htmlspecialchars($__Context->selected_var->desc, ENT_COMPAT | ENT_HTML401, 'UTF-8', false);
} ?>" class="lang_code" placeholder="Ex) Displayed as your choice." />
				</div>
			</div>
			<div class="x_control-group">
