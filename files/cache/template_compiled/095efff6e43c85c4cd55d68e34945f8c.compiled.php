...
<!--#Meta:modules/board/skins/product/css/board.css--><?php $__tmp=array('modules/board/skins/product/css/board.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/product/css/ie8.css--><?php $__tmp=array('modules/board/skins/product/css/ie8.css','','lt IE 9','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if($__Context->mi->colorset=='black'){ ?><!--#Meta:modules/board/skins/product/css/black.css--><?php $__tmp=array('modules/board/skins/product/css/black.css','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
...
.bd_zine > li > .bd_li_box > a:hover,.bd_zine > li > .bd_li_box > a:focus,.bd_zine .select a{border-color:#<?php echo $__Context->mi->color ?>;}
