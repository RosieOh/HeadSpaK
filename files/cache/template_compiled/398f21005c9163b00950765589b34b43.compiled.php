...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_read_files.html');
} ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_read_sns.html');
} ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_read_nav.html');
		...
		<?php if(!$__Context->mi->rd_nav_side){ ?><div class="rd_nav_side">
			<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_read_nav.html') ?>
		</div><?php } ?>
		<?php } ?>
	</div>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_comment_write.html');
} ?>
			
			<div id="cmtPosition" aria-live="polite"><?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_comment.html') ?></div>
