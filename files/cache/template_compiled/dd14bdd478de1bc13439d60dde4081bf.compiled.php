...
echo $__Context->val->filename ?>" style="max-height:60px" />
				...
				<td>
					<button type="button" class="x_btn x_btn-link" style="white-space:nowrap" onclick="XE.filebox.deleteFile('<?php echo $__Context->val->module_filebox_srl ?>');"><?php echo $__Context->lang->cmd_delete ?></button>
				</td>
			</tr><?php } ?>
		</tbody>
	</table>
