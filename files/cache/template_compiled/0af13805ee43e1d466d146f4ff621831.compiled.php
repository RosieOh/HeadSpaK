...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','__setting.html') ?>
<!--#Meta:modules/board/skins/review/js/imagesloaded.pkgd.min.js--><?php $__tmp=array('modules/board/skins/review/js/imagesloaded.pkgd.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/review/js/jquery.cookie.js--><?php $__tmp=array('modules/board/skins/review/js/jquery.cookie.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--#Meta:modules/board/skins/review/js/jquery.autogrowtextarea.min.js--><?php $__tmp=array('modules/board/skins/review/js/jquery.autogrowtextarea.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/review/js/board.js--><?php $__tmp=array('modules/board/skins/review/js/board.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<script>//<![CDATA[
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_viewer.html');
} ?>
<?php if($__Context->mi->default_style!='viewer'){ ?>
<!--#Meta:modules/board/skins/review/js/jquery.masonry.min.js--><?php $__tmp=array('modules/board/skins/review/js/jquery.masonry.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--#Meta:modules/board/skins/review/css/wizard.css--><?php $__tmp=array('modules/board/skins/review/css/wizard.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_wizard.php') ?>
<?php } ?>
<div class="bd_hd<?php if($__Context->oDocument->isExists()){ ?> v2<?php } ?> clear">
	<?php if(!$__Context->mi->breadcrumb){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_breadcrumb.html');
} ?>
...
<!--#Meta:modules/board/skins/review/js/font_ng.js--><?php $__tmp=array('modules/board/skins/review/js/font_ng.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_read_nav.html');
} ?>
</div>
<?php if($__Context->oDocument->isExists()){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_read.html');
} ?>
...
<div class="tl_srch clear">
	...
	<?php if($__Context->mi->srch_window!='N'){ ?><div class="bd_faq_srch<?php if($__Context->mi->srch_window==3){ ?> clear<?php } ?>"<?php if($__Context->mi->srch_window==2 || $__Context->search_keyword){ ?> style="display:block"<?php } ?>>
		<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_search.html') ?>
	</div><?php } ?>
</div>
...
<?php if($__Context->mi->default_style=='list'){ ?>
	...
	<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_list_normal.html') ?>
	<?php }else{ ?>
	<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_list_m.html') ?>
	<?php } ?>
<?php }elseif($__Context->mi->default_style=='webzine'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_list_webzine.html') ?>
<?php }elseif($__Context->mi->default_style=='gallery'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_list_gallery.html') ?>
<?php }elseif($__Context->mi->default_style=='cloud_gall'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_list_cloud_gall.html') ?>
<?php }elseif($__Context->mi->default_style=='faq'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_list_faq.html') ?>
<?php }elseif($__Context->mi->default_style=='guest' && !$__Context->oDocument->isExists()){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_list_guest.html') ?>
...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_read.html') ?>
...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/review','_footer.html') ?>
<?php } ?>