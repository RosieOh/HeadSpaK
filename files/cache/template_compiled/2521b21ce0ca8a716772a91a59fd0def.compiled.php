...
<!--#Meta:modules/board/skins/notice/css/board.css--><?php $__tmp=array('modules/board/skins/notice/css/board.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/notice/css/ie8.css--><?php $__tmp=array('modules/board/skins/notice/css/ie8.css','','lt IE 9','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if($__Context->mi->colorset=='black'){ ?><!--#Meta:modules/board/skins/notice/css/black.css--><?php $__tmp=array('modules/board/skins/notice/css/black.css','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
