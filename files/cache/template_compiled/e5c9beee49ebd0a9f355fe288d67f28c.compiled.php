	...
	<div class="header_mxwidth">
		<div class="header_logo_wrap">
			<a href="<?php echo $__Context->layout_info->header_logo_link ?>">
				<?php if($__Context->layout_info->header_logo){ ?><img src="<?php echo $__Context->layout_info->header_logo ?>"><?php } ?>				<?php if(!$__Context->layout_info->header_logo && $__Context->layout_info->header_text){ ?>
