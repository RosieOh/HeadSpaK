...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','__setting.html') ?>
<!--#Meta:modules/board/skins/market_search/js/imagesloaded.pkgd.min.js--><?php $__tmp=array('modules/board/skins/market_search/js/imagesloaded.pkgd.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/market_search/js/jquery.cookie.js--><?php $__tmp=array('modules/board/skins/market_search/js/jquery.cookie.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--#Meta:modules/board/skins/market_search/js/jquery.autogrowtextarea.min.js--><?php $__tmp=array('modules/board/skins/market_search/js/jquery.autogrowtextarea.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/market_search/js/board.js--><?php $__tmp=array('modules/board/skins/market_search/js/board.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<script>//<![CDATA[
...
//]]></script>
<?php if($__Context->mid == 'headspa_markets'){ ?>
	<?php if($__Context->lang_type == 'ko'){ ?>
	<div class="sub_title_wrap">
		<h1>헤드스파 K(국내)</h1>
	</div>
	<div class="sub_tab_wrap">
		<div class="sub_tab"><a href="/index.php?mid=partners">헤드스파 K 전문점 안내<p></p></a></div>
		<div class="sub_tab on"><a>국내</a></div>
		<div class="sub_tab"><a href="/index.php?mid=market_foreign">해외</a></div>
	</div>
	<select class="sub_sel" onchange="location.href=this.value">
		<option value="/index.php?mid=partners">헤드스파 K 전문점 안내</option>
		<option selected="selected" value="">국내</option>
		<option value="/index.php?mid=market_foreign">해외</option>
	</select>
	<?php } ?>
	<?php if($__Context->lang_type == 'en'){ ?>
	<div class="sub_title_wrap">
		<h1>Headspa K Partners(Domestic)</h1>
	</div>
	<div class="sub_tab_wrap">
		<div class="sub_tab"><a href="/index.php?mid=partners">Partner Information</a></div>
		<div class="sub_tab on"><a>Domestic markets</a></div>
		<div class="sub_tab"><a href="/index.php?mid=market_foreign">Overseas markets</a></div>
	</div>
	<select class="sub_sel" onchange="location.href=this.value">
		<option value="/index.php?mid=partners">Partner Information</option>
		<option selected="selected" value="">Domestic markets</option>
		<option value="/index.php?mid=market_foreign">Overseas markets</option>
	</select>
	<?php } ?>
	<?php }else if($__Context->lang_type == 'zh-CN'){ ?>
	<div class="sub_title_wrap">
		<h1>Head spa k 合作伙伴</h1>
	</div>
	<div class="sub_tab_wrap">
		<div class="sub_tab"><a href="/index.php?mid=partners">head spa k 专门店介绍<p></p></a></div>
		<div class="sub_tab on"><a>国内</a></div>
		<div class="sub_tab"><a href="/index.php?mid=market_foreign">海外</a></div>
	</div>
	<select class="sub_sel" onchange="location.href=this.value">
		<option value="/index.php?mid=partners">head spa k 专门店介绍</option>
		<option selected="selected" value="">国内</option>
		<option value="/index.php?mid=market_foreign">海外</option>
	</select>
	<?php } ?>
<?php if($__Context->mi->default_style=='viewer' && $__Context->grant->view){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_viewer.html');
} ?>
<?php if($__Context->mi->default_style!='viewer'){ ?>
<!--#Meta:modules/board/skins/market_search/js/jquery.masonry.min.js--><?php $__tmp=array('modules/board/skins/market_search/js/jquery.masonry.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--#Meta:modules/board/skins/market_search/css/wizard.css--><?php $__tmp=array('modules/board/skins/market_search/css/wizard.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_wizard.php') ?>
<?php } ?>
<div class="bd_hd<?php if($__Context->oDocument->isExists()){ ?> v2<?php } ?> clear">
	<?php if(!$__Context->mi->breadcrumb){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_breadcrumb.html');
} ?>
...
<!--#Meta:modules/board/skins/market_search/js/font_ng.js--><?php $__tmp=array('modules/board/skins/market_search/js/font_ng.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_read_nav.html');
} ?>
</div>
<?php if($__Context->oDocument->isExists()){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_read.html');
} ?>
...
<div class="tl_srch clear">
	...
	<?php if($__Context->mi->srch_window!='N'){ ?><div class="bd_faq_srch<?php if($__Context->mi->srch_window==3){ ?> clear<?php } ?>"<?php if($__Context->mi->srch_window==2 || $__Context->search_keyword){ ?> style="display:block"<?php } ?>>
		<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_search.html') ?>
	</div><?php } ?>
</div>
...
<?php if($__Context->mi->default_style=='list'){ ?>
	...
	<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_list_normal.html') ?>
	<?php }else{ ?>
	<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_list_m.html') ?>
	<?php } ?>
<?php }elseif($__Context->mi->default_style=='webzine'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_list_webzine.html') ?>
<?php }elseif($__Context->mi->default_style=='gallery'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_list_gallery.html') ?>
<?php }elseif($__Context->mi->default_style=='cloud_gall'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_list_cloud_gall.html') ?>
<?php }elseif($__Context->mi->default_style=='faq'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_list_faq.html') ?>
<?php }elseif($__Context->mi->default_style=='guest' && !$__Context->oDocument->isExists()){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_list_guest.html') ?>
...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_read.html') ?>
...
<?php if(!$__Context->mi->display_setup_button){ ?><div class="btm_mn clear">
	...
	<div class="fl">
		...
		<?php if($__Context->mi->srch_btm!='N' && !Mobile::isMobileCheckByAgent()){ ?><form style="display:none;" action="<?php echo getUrl() ?>" method="get" onsubmit="return procFilter(this, search)" class="bd_srch_btm<?php if($__Context->mi->srch_btm==2 || $__Context->search_keyword){ ?> on<?php } ?>" ><input type="hidden" name="act" value="<?php echo $__Context->act ?>" />
...
<!-- 2020-01-17 페이지 나오는 코딩 백업본 있어서 지움. 추후에 필요하면 백업파일에서 추가 -->
</div><?php } ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_footer.html') ?>
<?php } ?>
