...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_read_files.html');
} ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_read_sns.html');
} ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_read_nav.html');
		...
		<?php if(!$__Context->mi->rd_nav_side){ ?><div class="rd_nav_side">
			<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_read_nav.html') ?>
		</div><?php } ?>
		<?php } ?>
	</div>
...
if(in_array(strtolower(substr(strrchr($__Context->file->source_filename, '.'), 1)), array('jpg','jpeg','png','gif','webp'))){ ?><div class="swiper-slide rd_sli">
		...
		<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','extravar_table.html') ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_comment_write.html');
} ?>
			
			<div id="cmtPosition" aria-live="polite"><?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/market_search','_comment.html') ?></div>
