...
<?php } ?>
<!--#Meta:modules/board/skins/notice/css/print.css--><?php $__tmp=array('modules/board/skins/notice/css/print.css','print','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/notice/js/viewer.js--><?php $__tmp=array('modules/board/skins/notice/js/viewer.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php 
...
<!--#Meta:modules/board/skins/notice/js/jquery.mousewheel.min.js--><?php $__tmp=array('modules/board/skins/notice/js/jquery.mousewheel.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/notice/js/jquery.mCustomScrollbar.min.js--><?php $__tmp=array('modules/board/skins/notice/js/jquery.mCustomScrollbar.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/notice/css/jquery.mCustomScrollbar.css--><?php $__tmp=array('modules/board/skins/notice/css/jquery.mCustomScrollbar.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
