...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','__setting.html') ?>
<!--#Meta:modules/board/skins/notice/js/imagesloaded.pkgd.min.js--><?php $__tmp=array('modules/board/skins/notice/js/imagesloaded.pkgd.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/notice/js/jquery.cookie.js--><?php $__tmp=array('modules/board/skins/notice/js/jquery.cookie.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--#Meta:modules/board/skins/notice/js/jquery.autogrowtextarea.min.js--><?php $__tmp=array('modules/board/skins/notice/js/jquery.autogrowtextarea.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/notice/js/board.js--><?php $__tmp=array('modules/board/skins/notice/js/board.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<script>//<![CDATA[
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_viewer.html');
} ?>
	<?php if($__Context->mi->default_style!='viewer'){ ?>
		<!--#Meta:modules/board/skins/notice/js/jquery.masonry.min.js--><?php $__tmp=array('modules/board/skins/notice/js/jquery.masonry.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
if($__Context->mi->rd_nav_side || $__Context->mi->default_style=='blog' || $__Context->mi->default_style=='guest'){ ?> data-bdNavSide="N"<?php } ?>>
			...
			<?php if($__Context->grant->manager && $__Context->mi->wizard!='N' && !Mobile::isMobileCheckByAgent()){ ?>
				<!--#Meta:modules/board/skins/notice/css/wizard.css--><?php $__tmp=array('modules/board/skins/notice/css/wizard.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
				<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_wizard.php') ?>
			<?php } ?>
			
			<div class="bd_hd<?php if($__Context->oDocument->isExists()){ ?> v2<?php } ?> clear">
				
				<?php if(!$__Context->mi->breadcrumb){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_breadcrumb.html');
} ?>
					...
					<!-- <?php if($__Context->mi->font_btn!='N'){ ?><div class="bd_font m_no fr"<?php if($__Context->oDocument->isExists() || $__Context->mi->font_btn=='2'){ ?> style="display:none"<?php } ?>>
						<!--#Meta:modules/board/skins/notice/js/font_ng.js--><?php $__tmp=array('modules/board/skins/notice/js/font_ng.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
						<a class="select tg_btn2" href="#" data-href=".bd_font_select"><b>T</b><strong>나눔고딕<?php echo $__Context->lang->window_font;
echo $__Context->lang->tahoma;
echo $__Context->lang->best_font ?></strong><span class="arrow down"></span></a>
						<div class="bd_font_select tg_cnt2"><button type="button" class="tg_blur2"></button>
							<ul>
								<li class="ui_fonton"><a href="#" title="<?php echo $__Context->lang->best_font_dsc ?>"><?php echo $__Context->lang->best_font ?></a><em>✔</em></li>
								<li class="ng on"><a href="#">나눔고딕</a><em>✔</em></li>
								<li class="window_font on"><a href="#"><?php echo $__Context->lang->window_font ?></a><em>✔</em></li>
								<li class="tahoma on"><a href="#"><?php echo $__Context->lang->tahoma ?></a><em>✔</em></li>
					...
					<div class="bd_set fr m_btn_wrp m_no">
						<?php if($__Context->grant->view && $__Context->mi->default_style!='guest' && $__Context->mi->default_style!='blog'){ ?>
							...
							<?php if($__Context->mi->viewer_with!='N'){ ?><a class="viewer_with bubble on" href="#" title="<?php echo $__Context->lang->with_viewer_info ?>."><em>✔</em> <strong><?php echo $__Context->lang->link_site_viewer ?></strong></a><?php } ?>
						
							<?php if(!$__Context->oDocument->isExists() && $__Context->mi->viewer_with!='N'){ ?><a class="viewer_with rd_viewer bubble on" href="#" title="<?php echo $__Context->lang->with_viewer_info ?>."><em>✔</em> <strong><?php echo $__Context->lang->with_viewer ?></strong></a><?php } ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_read_nav.html');
} ?>
					</div>
					
					<?php if($__Context->oDocument->isExists()){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_read.html');
} ?>
						...
						<?php if(!$__Context->oDocument->isExists() || ($__Context->oDocument->isExists() && !$__Context->mi->rd_lst)){ ?><div class="bd_lst_wrp">
							<div class="tl_srch clear">
								...
								<?php if($__Context->mi->srch_window!='N'){ ?><div class="bd_faq_srch<?php if($__Context->mi->srch_window==3){ ?> clear<?php } ?>"<?php if($__Context->mi->srch_window==2 || $__Context->search_keyword){ ?> style="display:block"<?php } ?>>
									<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_search.html') ?>
								</div><?php } ?>
							</div>
...
if($__Context->mi->cnb_count){ ?><small>(<?php echo $__Context->val->document_count ?>)</small><?php } ?></a>
									...
									<?php if(!$__Context->mi->select_lst){ ?><div class="lst_btn fr">
										<ul>
											<li class="classic on"><a class="bubble" href="<?php echo getUrl('listStyle','list','act','','document_srl','') ?>" title="Text Style"><b>List</b></a></li>
											<li class="zine on"><a class="bubble" href="<?php echo getUrl('listStyle','webzine','act','','document_srl','') ?>" title="Text + Image Style"><b>Zine</b></a></li>
											<li class="gall on"><a class="bubble" href="<?php echo getUrl('listStyle','gallery','act','','document_srl','') ?>" title="Gallery Style"><b>Gallery</b></a></li>
											<?php if($__Context->mi->select_lst_more){ ?><li class="cloud on"><a class="bubble" href="<?php echo getUrl('listStyle','cloud_gall','act','','document_srl','') ?>" title="Photo Cloud"><b>Cloud</b></a></li><?php } ?>
										</ul>
									</div><?php } ?> -->
								</div>
								...
								<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_list_normal.html') ?>
								<?php }else{ ?>
								<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_list_m.html') ?>
								<?php } ?>
								<?php }elseif($__Context->mi->default_style=='webzine'){ ?>
								<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_list_webzine.html') ?>
								<?php }elseif($__Context->mi->default_style=='gallery'){ ?>
								<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_list_gallery.html') ?>
								<?php }elseif($__Context->mi->default_style=='cloud_gall'){ ?>
								<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_list_cloud_gall.html') ?>
								<?php }elseif($__Context->mi->default_style=='faq'){ ?>
								<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_list_faq.html') ?>
								<?php }elseif($__Context->mi->default_style=='guest' && !$__Context->oDocument->isExists()){ ?>
								<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_list_guest.html') ?>
...
$__Context->mi->rd_nav='';
								...
								<?php if($__Context->document_list&&count($__Context->document_list))foreach($__Context->document_list as $__Context->no=>$__Context->oDocument){ ?>
									<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_read.html') ?>
...
if($__Context->page_no!=1 && $__Context->page_no!=$__Context->page_navigation->last_page){ ?>
							...
							<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/notice','_footer.html') ?>
						<?php } ?>