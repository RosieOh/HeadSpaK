...
<!--#Meta:modules/board/skins/clinic/css/board.css--><?php $__tmp=array('modules/board/skins/clinic/css/board.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/clinic/css/ie8.css--><?php $__tmp=array('modules/board/skins/clinic/css/ie8.css','','lt IE 9','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if($__Context->mi->colorset=='black'){ ?><!--#Meta:modules/board/skins/clinic/css/black.css--><?php $__tmp=array('modules/board/skins/clinic/css/black.css','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
