...
$__Context->oDocument->getEditor()->option;
 ?>
<!--#Meta:modules/board/skins/product/css/m_editor.css--><?php $__tmp=array('modules/board/skins/product/css/m_editor.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/product/js/editor_m.js--><?php $__tmp=array('modules/board/skins/product/js/editor_m.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/product/js/ajaxfileupload.js--><?php $__tmp=array('modules/board/skins/product/js/ajaxfileupload.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<script>//<![CDATA[
...
<!--#Meta:modules/board/skins/product/js/editor_wysiwyg.js--><?php $__tmp=array('modules/board/skins/product/js/editor_wysiwyg.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/product/js/bootstrap-wysiwyg.js--><?php $__tmp=array('modules/board/skins/product/js/bootstrap-wysiwyg.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/product/js/jquery.hotkeys.js--><?php $__tmp=array('modules/board/skins/product/js/jquery.hotkeys.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
		<div id="alerts"></div>
...
<!--#Meta:modules/board/skins/product/js/editor_textarea.js--><?php $__tmp=array('modules/board/skins/product/js/editor_textarea.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
