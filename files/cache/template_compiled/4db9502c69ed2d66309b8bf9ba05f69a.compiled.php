...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','__setting.html') ?>
<!--#Meta:modules/board/skins/clinic/js/imagesloaded.pkgd.min.js--><?php $__tmp=array('modules/board/skins/clinic/js/imagesloaded.pkgd.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/clinic/js/jquery.cookie.js--><?php $__tmp=array('modules/board/skins/clinic/js/jquery.cookie.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--#Meta:modules/board/skins/clinic/js/jquery.autogrowtextarea.min.js--><?php $__tmp=array('modules/board/skins/clinic/js/jquery.autogrowtextarea.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/clinic/js/board.js--><?php $__tmp=array('modules/board/skins/clinic/js/board.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<script>//<![CDATA[
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_viewer.html');
} ?>
<?php if($__Context->mi->default_style!='viewer'){ ?>
<!--#Meta:modules/board/skins/clinic/js/jquery.masonry.min.js--><?php $__tmp=array('modules/board/skins/clinic/js/jquery.masonry.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--#Meta:modules/board/skins/clinic/css/wizard.css--><?php $__tmp=array('modules/board/skins/clinic/css/wizard.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_wizard.php') ?>
<?php } ?>
...
<!--#Meta:modules/board/skins/clinic/js/font_ng.js--><?php $__tmp=array('modules/board/skins/clinic/js/font_ng.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_read_nav.html');
} ?>
</div>
<?php if($__Context->oDocument->isExists()){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_read.html');
} ?>
...
<div class="tl_srch clear">
	...
	<?php if($__Context->mi->srch_window!='N'){ ?><div class="bd_faq_srch<?php if($__Context->mi->srch_window==3){ ?> clear<?php } ?>"<?php if($__Context->mi->srch_window==2 || $__Context->search_keyword){ ?> style="display:block"<?php } ?>>
		<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_search.html') ?>
	</div><?php } ?>
</div>
...
<?php if($__Context->mi->default_style=='list'){ ?>
	...
	<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_list_normal.html') ?>
	<?php }else{ ?>
	<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_list_m.html') ?>
	<?php } ?>
<?php }elseif($__Context->mi->default_style=='webzine'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_list_webzine.html') ?>
<?php }elseif($__Context->mi->default_style=='gallery'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_list_gallery.html') ?>
<?php }elseif($__Context->mi->default_style=='cloud_gall'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_list_cloud_gall.html') ?>
<?php }elseif($__Context->mi->default_style=='faq'){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_list_faq.html') ?>
<?php }elseif($__Context->mi->default_style=='guest' && !$__Context->oDocument->isExists()){ ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_list_guest.html') ?>
...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_read.html') ?>
...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/clinic','_footer.html') ?>
<?php } ?>