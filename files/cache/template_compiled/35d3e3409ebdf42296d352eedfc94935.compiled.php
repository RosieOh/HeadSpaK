...
<?php if($__Context->mid == 'market_foreign'){ ?>
	...
	<div class="sub_tab_wrap">
		<div class="sub_tab"><a href="/index.php?mid=partners">헤드스파 K 파트너 안내<p></p></a></div>
	...
	<div class="sub_tab_wrap">
		<div class="sub_tab"><a href="/index.php?mid=partners">Partnership guide</a></div>
	...
	<select class="sub_sel" onchange="location.href=this.value">
		<option value="/index.php?mid=partners">Partnership guide</option>
