...
class ExtraItem
{
	...
	function getFormHTML()
	{
		...
		$oModuleController = getController('module'); $oModuleController->replaceDefinedLangCode($this->default); $default = $this->_getTypeValue($this->type, htmlspecialchars($this->default, ENT_COMPAT | ENT_HTML401, 'UTF-8', false));
